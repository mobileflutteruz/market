...
abstract class $TokenResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool status, String accessToken, String tokenType, String message});
}
...
class _$TokenResponseImpl implements _TokenResponse {
  ...
  @override
  String toString() {
    return 'TokenResponse(status: $status, accessToken: $accessToken, tokenType: $tokenType, message: $message)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, accessToken, tokenType, message);
...
abstract class _TokenResponse implements TokenResponse {
  const factory _TokenResponse(
      ...
      required final String message}) = _$TokenResponseImpl;
