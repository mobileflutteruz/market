...
class _$SearchProductImpl implements _SearchProduct {
  ...
  @override
  String toString() {
    return 'SearchProduct(id: $id, name: $name, description: $description, details_of_product: $details_of_product, price: $price, quantity: $quantity, quantity_rest: $quantity_rest, discount: $discount, image: $image, status: $status, product_type: $product_type, category_id: $category_id, created_at: $created_at, updated_at: $updated_at)';
  }
