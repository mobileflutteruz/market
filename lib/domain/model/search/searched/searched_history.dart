...
class SearchedHistory with _$SearchedHistory {
    ...
    factory SearchedHistory.fromJson(Map<String, dynamic> json) => _$SearchedHistoryFromJson(json);
}
...
class TopSearch with _$TopSearch {
    ...
    factory TopSearch.fromJson(Map<String, dynamic> json) => _$TopSearchFromJson(json);
}
