...
import 'package:karmango/presentation/food_profile/components/profile_app_bar.dart';
import 'package:karmango/presentation/food_profile/components/profile_card_item.dart';
...
class FoodProfileNotSignInPage extends StatefulWidget {
  const FoodProfileNotSignInPage({super.key});

  @override
  State<FoodProfileNotSignInPage> createState() => _FoodProfileNotSignInPageState();
}

class _FoodProfileNotSignInPageState extends State<FoodProfileNotSignInPage> {
  @override
