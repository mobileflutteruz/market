...
import '../app_init/cubit/app_init_cubit.dart' as _i17;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i14.CategoryProductCubit>(
        () => _i14.CategoryProductCubit(gh<_i13.DataRepository>()));
    gh.factory<_i15.CategoryCubit>(
        () => _i15.CategoryCubit(gh<_i13.DataRepository>()));
    gh.factory<_i16.FavouritesCubit>(() => _i16.FavouritesCubit(
          gh<_i9.MainRepository>(),
          gh<_i13.DataRepository>(),
        ));
    gh.factory<_i17.AppInitCubit>(() => _i17.AppInitCubit(
          gh<_i11.UserSessionManager>(),
          gh<_i12.Api>(),
        ));
